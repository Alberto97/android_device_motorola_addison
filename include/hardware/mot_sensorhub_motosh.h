...
#define SENSOR_TYPE_DISPLAY_ROTATE      SENSOR_TYPE_DEVICE_ORIENTATION
...
#define SENSORHUB_ALGO_MODALITY         MOTOSH_IDX_MODALITY
#define SENSORHUB_ALGO_ORIENTATION      MOTOSH_IDX_ORIENTATION
#define SENSORHUB_ALGO_STOWED           MOTOSH_IDX_STOWED
#define SENSORHUB_ALGO_ACCUM_MODALITY   MOTOSH_IDX_ACCUM_MODALITY
#define SENSORHUB_ALGO_ACCUM_MVMT       MOTOSH_IDX_ACCUM_MVMT
